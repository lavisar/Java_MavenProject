...
a persistence unit "ebjmaven-set2PersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/org/lavi/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "ebjmaven-set2/pom.xml":
...
artifacts ("ebjmaven-set2-ejb.jar" and "ebjmaven-set2-web.war") are already built. You can build
